...
const CalcContainer = styled(Grid)`height: calc(100% - 42px); z-index: 10;`
...
export default function TakePictureWithCam() {
  ...
  const { videoRef, resetMainPageState } = useTakePicture()
  ...
  return (
    <FullHeightContainer data-testid="takePictureWithCamContainer" item container direction="row" >
      <BorderedContainer alignItems="center" container style={{ backgroundColor: '#80808066', height: '40px' }}>
        {/* implement i18n */}
        <span data-testid="takePictureWithCamClose" onClick={() => resetMainPageState()} style={{ fontWeight: 600, padding: '10px', cursor: 'pointer' }}>x</span>
